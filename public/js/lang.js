...
LOCALE.zh = {
  ...
  msg_load_error: "加载异常",
  battle_channel_prefix: "私聊通道已建立：",
  btn_copied: "OK 已复制",
  btn_copy_invite: "复制邀请",
  btn_confirm_add: "确认添加",
  btn_adding: "添加中...",
  msg_error_prefix: "Error: ",
  msg_nickname_required: "昵称不能为空",
  btn_saving: "保存中...",
  msg_save_fail: "保存失败: ",
  avatar_selected: "已选择自定义头像",
  select_avatar: "选择头像",
  btn_upload_avatar: "上传自定义头像",
  invite_step1: "Step1 第1步：发送邀请",
  invite_step2: "Step2 第2步：粘贴 Agent 配置 JSON",
  invite_step1_desc: "复制下方邀请文案，发送给目标 Agent（通过飞书、WebUI 等渠道）：",
  invite_step2_desc: "粘贴 Agent 回复的 JSON 配置：",
  invite_json_placeholder: "粘贴 JSON...",
  btn_edit: "编辑",
  btn_prev: "上一步",
  btn_reset: "重置",
  theme_light: "极简白",
  ...
  msg_export_ok: "导出成功: ",
  export_chat_title: "Agent Hub 聊天记录 - {date}",
  ...
  // confirm modal
  confirm_exit: "确定要退出 Agent Hub 吗？",
  confirm_delete_agent: "确定要移除 Agent {id} 吗？",
  confirm_delete_project: "确认删除项目「{name}」吗？该项目下的聊天记录也将被清除。",

  // rules panel
  rules_builtin_header: "\u2699\ufe0f 已生效的内置规则",
  rules_rule1: "Agent 务实精简：群聊中禁止客套话/废话，直接说重点",
  rules_rule2: "@模式：被 @提及时 Agent 可展开详述，不受简洁限制",
  rules_rule3: "Battle 模式：无轮数限制，可引用数据/表格，直到手动 /stop",
  rules_custom_hint: "自定义规则会追加到 Agent 的 system prompt 中，影响其行为",

  // anim panel
  anim_fast: "快",
  anim_slow: "慢",
  anim_unit: "px/s\uff085-100\uff09",
  ...
  btn_save_rules: "保存规则",
  btn_return: "\u2190 返回",
  btn_new_project: "创建项目",
  btn_select_agents: "选择参与 Agent：",
  btn_new_project_title: "\u2795 新建项目",
  btn_existing_projects: "已有项目",
  btn_no_projects: "暂无项目",
  btn_project_name: "项目名称",
  btn_edit_project_title: "\u270f\ufe0f 编辑项目",
  btn_placeholder_project_name: "请输入项目名称",
  btn_upload_avatar_label: "\ud83d\udcc1 上传自定义头像",
  btn_placeholder_nickname: "输入昵称...",

  // exit button
  btn_exit_label: "\u23fb 退出程序",

  // log
  btn_open_log_label: "\ud83d\udcca 打开日志文件",

  // settings sections
  settings_project_label: "\ud83d\udcc1 项目管理",
  settings_agent_label: "\ud83e\udd16 Agent 管理",
  settings_rules_label: "\ud83d\udcdc 发言规则",
  settings_user_label: "\ud83d\udc64 用户设置",
  settings_animation_label: "\ud83c\udfac Agent 动画",
  settings_log_label: "\ud83e\udeab 日志",
  settings_language_label: "\ud83c\udf10 语言",
  settings_export_label: "\ud83d\udce5 导出保存位置",


  // history sidebar
  history_date_format: "{m}月{d}日",
  history_msg_count: "条",
  history_more: "更多",
  history_collapse: "收起",
  // 命令描述
...
LOCALE.en = {
  ...
  battle_channel_prefix: "Private channel established: ",
  btn_copied: "OK Copied",
  btn_copy_invite: "Copy Invite",
  btn_confirm_add: "Confirm Add",
  btn_adding: "Adding...",
  msg_error_prefix: "Error: ",
  msg_nickname_required: "Nickname is required",
  btn_saving: "Saving...",
  msg_save_fail: "Save failed: ",
  avatar_selected: "Custom avatar selected",
  select_avatar: "Select Avatar",
  btn_upload_avatar: "Upload Avatar",
  invite_step1: "Step 1: Send Invitation",
  invite_step2: "Step 2: Paste Agent Config JSON",
  invite_step1_desc: "Copy the invitation below and send it to the target Agent (via Feishu, WebUI, etc.):",
  invite_step2_desc: "Paste the Agent's JSON configuration response:",
  invite_json_placeholder: "Paste JSON...",
  btn_edit: "Edit",
  btn_prev: "Previous",
  btn_reset: "Reset",
  theme_light: "Light",
  ...
  export_chat_title: "Agent Hub Chat History - {date}",
  ...
  // confirm modal
  confirm_exit: "Are you sure you want to exit Agent Hub?",
  confirm_delete_agent: "Remove Agent {id}?",
  confirm_delete_project: "Are you sure you want to delete project \"{name}\"? Chat history under this project will also be removed.",

  // rules panel
  rules_builtin_header: "\u2699\ufe0f Active Built-in Rules",
  rules_rule1: "Concise Agent speech: no greetings/fluff in group chat, get straight to the point",
  rules_rule2: "@mode: When @mentioned, Agent can elaborate in detail, concise rule lifted",
  rules_rule3: "Battle mode: no round limit, can cite data/tables, until manual /stop",
  ...
  // hall
  hall_expand: "Expand Hall",
  hall_collapse: "Collapse Hall",
  hall_toggle: "Toggle Hall",

  // buttons
  btn_save_rules: "Save Rules",
  btn_return: "\u2190 Back",
  btn_new_project: "Create",
  btn_select_agents: "Select participating Agents:",
  btn_new_project_title: "\u2795 New Project",
  btn_existing_projects: "Existing Projects",
  btn_no_projects: "No projects yet",
  btn_project_name: "Project Name",
  btn_edit_project_title: "\u270f\ufe0f Edit Project",
  btn_placeholder_project_name: "Enter project name",
  btn_upload_avatar_label: "\ud83d\udcc1 Upload Avatar",
  btn_placeholder_nickname: "Enter nickname...",

  // exit button
  btn_exit_label: "\u23fb Exit",

  // log
  btn_open_log_label: "\ud83d\udcca Open Log",

  // settings sections
  settings_project_label: "\ud83d\udcc1 Project Management",
  settings_agent_label: "\ud83e\udd16 Agent Management",
  settings_rules_label: "\ud83d\udcdc Speech Rules",
  settings_user_label: "\ud83d\udc64 User Settings",
  settings_animation_label: "\ud83c\udfac Agent Animation",
  settings_log_label: "\ud83e\udeab Log",
  settings_language_label: "\ud83c\udf10 Language",
  settings_export_label: "\ud83d\udce5 Export Location",

  
  // history sidebar
  history_date_format: "{m}/{d}",
  history_msg_count: " msgs",
  history_more: "More",
...
(function initLocale() {
  ...
  // splash_done is set in setLocale() before reload, so on language-switch page loads it persists
})();
